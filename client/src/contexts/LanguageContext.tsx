...
const copy = {
  en: {
    ...
    ledger: "Ledger",
    variances: "Variances",
    pharmacyPrototype: "Pharmacy preview",
    ...
    aiBadgeTooltip: "AI gives user-requested, same-branch review suggestions only. It cannot reconcile, settle, resolve, post, or approve.",
    allPriorityVariances: "All priority",
    savedAiSuggestions: "AI suggestions",
    noSavedAiSuggestions: "No open variance has a saved AI suggestion.",
    investigationNotes: "Investigation notes",
    noInvestigationNotes: "No investigation notes have been recorded.",
    addInvestigationNote: "Add an investigation note",
    addNote: "Add note",
  ...
  ha: {
    ...
    pharmacyPrototype: "Samfurin duba kantin magani",
    ...
    aiBadgeTooltip: "AI yana ba da shawarar dubawa ne kawai idan mai izini ya nema daga wannan reshe. Ba ya iya daidaitawa, biyan bashi, warwarewa, wallafawa, ko amincewa.",
    allPriorityVariances: "Dukkan fifiko",
    savedAiSuggestions: "Shawarwarin AI",
    noSavedAiSuggestions: "Babu bambanci buɗe mai adana shawarar AI.",
    investigationNotes: "Bayanan bincike",
    noInvestigationNotes: "Ba a rubuta bayanan bincike ba.",
    addInvestigationNote: "Ƙara bayanin bincike",
    addNote: "Ƙara bayani",
    attachments: "Abubuwan da aka haɗa",
    attachFiles: "Haɗa fayiloli",
