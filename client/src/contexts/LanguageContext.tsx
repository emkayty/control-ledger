...
const copy = {
  en: {
    ...
    aiFocus: "AI suggests where to look. People still decide what happens.",
    aiUsageLimit: "Up to 3 saved analyses per case in 24 hours.",
    aiPrepareEnable: "Before you turn it on",
    aiAcknowledge: "I understand that this sends only the stated, minimised variance data for review-only suggestions.",
    aiConfirmPhrase: "Type ENABLE VARIANCE AI to confirm",
    enableReviewOnly: "Enable review-only AI",
    cancel: "Cancel",
  ...
  ha: {
    ...
    aiFocus: "AI yana nuna inda za a fara dubawa. Mutane ne ke yanke abin da zai faru.",
    aiUsageLimit: "Har zuwa bincike 3 da aka adana ga kowane lamari cikin awa 24.",
    aiPrepareEnable: "Kafin a kunna shi",
    aiAcknowledge: "Na fahimci cewa wannan zai aika ne kawai da taƙaitattun bayanan bambancin da aka bayyana domin shawarwari na dubawa kawai.",
    aiConfirmPhrase: "Rubuta ENABLE VARIANCE AI domin tabbatarwa",
    enableReviewOnly: "Kunna AI na dubawa kawai",
    cancel: "Soke",
