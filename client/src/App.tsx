...
function Router() { return <Switch><Route path="/"><ProtectedPage><ControlDashboard /></ProtectedPage></Route><Route path="/receivables"><ProtectedPage><ReceivablesPage /></ProtectedPage></Route><Route path="/evidence"><ProtectedPage><EvidencePage /></ProtectedPage></Route><Route path="/operations"><ProtectedPage><OperationsPage /></ProtectedPage></Route><Route path="/collections"><ProtectedPage><CollectionsPage /></ProtectedPage></Route><Route path="/ledger"><ProtectedPage><LedgerPage /></ProtectedPage></Route><Route path="/variances"><ProtectedPage><VariancesPage /></ProtectedPage></Route><Route path="/exceptions"><ProtectedPage><ExceptionsPage /></ProtectedPage></Route><Route path="/access"><ProtectedPage><AccessPage /></ProtectedPage></Route><Route path="/audit"><ProtectedPage><AuditPage /></ProtectedPage></Route><Route path="/404" component={NotFound} /><Route component={NotFound} /></Switch>; }
